...
public final class DualPersonalityTimeHud {
    ...
    public static void register() {
        TimeHudApi.registerProvider(NoellesRolesCore.id("dual_personality/double_active_time"), PRIORITY, player -> {
            /*
             * 只有“双活阶段”才接管屏幕正上方时间。
             ...
             */
            return TimeHudApi.TimeDisplay.showFixedColor(time, DualPersonalityConstants.COLOR);
        });
    }
}
