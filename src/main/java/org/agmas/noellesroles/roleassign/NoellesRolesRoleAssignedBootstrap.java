...
import org.agmas.noellesroles.roles.drugmaker.DrugmakerRoleAssignedHandler;
...
import org.agmas.noellesroles.roles.lich.LichRoleAssignedHandler;
...
public final class NoellesRolesRoleAssignedBootstrap {
    ...
    public static void init() {
        ...
        ModdedRoleAssigned.EVENT.register((player, role) -> {
            ...
            DrugmakerRoleAssignedHandler.onRoleAssigned(player, role);
            KidnapperRoleAssignedHandler.onRoleAssigned(player, role);
            RobotRoleAssignedHandler.onRoleAssigned(player, role);
